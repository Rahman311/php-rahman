...
<FORM method="post" action="/rez.php">
 ...
 <p>Ответьте да или нет на следующие вопросы: <br>
 ...
 2. Раздражают ли Вам мелкие повседневные обязанности? <br>
 ...
 18. Раздражает ли Вам современная живопись? <br>
 ...
 <input type ="radio" name="v20" value="1" checked/>Да
